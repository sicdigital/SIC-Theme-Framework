...
class SicFramework
{
	 ...
	 * Set Defaults 
	 *
	 * Store any default settings to use as defaults for this theme. 
	 * These settings can be overriden when extending the theme or by admin settings. 
	 *
	 * 
	 **/
